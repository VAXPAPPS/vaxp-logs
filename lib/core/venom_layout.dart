...
/// VenomScaffold - Main layout with sidebar and custom title bar
...
class _VenomScaffoldState extends State<VenomScaffold> {
  ...
  // Default colors
  final Color _backgroundColor = VaxpColors.darkGlassBackground;
...
/// VenomAppbar - Custom title bar with macOS-style window buttons
...
/// VenomWindowButton - macOS-style window control button
